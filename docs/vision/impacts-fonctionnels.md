...
- **Reste (v1.1+)** : brancher les caps sur la zone « Définir un cap » des mini-lemniscates du Profil ; afficher « De [Posture de Seuil] vers [posture-cible] » ; **lien de rejeu du bloc 3 depuis le Profil** (comme blocs 1-2) ; 12 illustrations Codex ([bloc-3-illustrations.md](../pedagogie/bloc-3-illustrations.md)) ; **bloc 4 (l'Appel) à l'entrée du Monde 1** (décidé — la clôture du bloc 3 laisse la « porte suspendue » que le bloc 4 rouvrira).
