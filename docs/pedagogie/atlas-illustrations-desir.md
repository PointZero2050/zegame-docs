# Atlas du Désir — 27 médaillons d'archétypes à générer

> Ajout Claude - 2026-07-18, pour Codex. Fait suite au **pilote de 9 vignettes** (diagonale O1-L1 / O2-L2 / O3-L3 × 3 états) livré dans [`assets/atlas/desir/pilot/`](assets/atlas/desir/pilot/) et **intégré en production** sur la fiche puissance (`/puissances/desir`) : le chemin est dérivé automatiquement (`{slug}-o{O}-l{L}-{etat}.png`), repli sur l'illustration ronde du pôle si la vignette manque. Cette note demande les **18 positions restantes** pour compléter le Désir (27 au total). Contenu de référence : [`corpus-point-zero/03_archetypes/desir.md`](corpus-point-zero/03_archetypes/desir.md) et la fiche `config/puissances/desir.yml` (descriptions validées).
...
| O1-L2 | Retenue · Exaltation | Bloqué | **Le Célébrant inquiet** | Exaltation vive doublée d'une peur sourde de la retombée ; joie tendue. | à générer |
| O1-L2 | Retenue · Exaltation | En chemin | **Le Funambule du plaisir** | Apprend à ralentir sans croire que la flamme s'éteint ; équilibre en apprentissage. | à générer |
| O1-L2 | Retenue · Exaltation | Intégré | **Le Célébrant lucide** | S'abandonne à l'exaltation puis revient de lui-même avant la saturation. | à générer |
| O1-L3 | Retenue · Ferveur | Bloqué | **Le Feu qui refuse la nuit** | Intensité permanente, refus de toute baisse ; grand feu, aucune ombre acceptée, peur du vide. | à générer |
| O1-L3 | Retenue · Ferveur | En chemin | **Le Porte-Flamme en initiation** | Commence à déposer sa ferveur par moments sans la renier ; flamme qu'on repose. | à générer |
| O1-L3 | Retenue · Ferveur | Intégré | **Le Porte-Flamme** | Engage tout son feu puis le contient au bon moment ; ferveur au service de la vie. | à générer |
| O2-L1 | Contrôle · Amplification | Bloqué | **Le Désir négocié** | Ne s'autorise à vouloir qu'après légitimité extérieure ; élan sous contrôle, tribunal intérieur. | à générer |
| O2-L1 | Contrôle · Amplification | En chemin | **L'Élan en réhabilitation** | Rouvre prudemment un espace de désir longtemps tenu en laisse. | à générer |
| O2-L1 | Contrôle · Amplification | Intégré | **Le Canaliseur vivant** | Concentre l'énergie sans la mutiler, sait la réamplifier ; le contrôle comme lit du fleuve. | à générer |
...
| O2-L3 | Contrôle · Ferveur | Bloqué | **Le Volcan corseté** | Ferveur extrême sous une pression de contrôle ; énorme énergie tenue à bout de bras, tension. | à générer |
| O2-L3 | Contrôle · Ferveur | En chemin | **Le Feu en alchimisation** | Le contrôle cesse d'étouffer le feu et commence à le raffiner ; métamorphose. | à générer |
| O2-L3 | Contrôle · Ferveur | Intégré | **Le Fervent souverain** | Discipline profonde au service d'une ferveur totale ; brasier gouverné, main sûre. | à générer |
| O3-L1 | Extinction · Amplification | Bloqué | **Le Désir enseveli** | Ne se conçoit plus capable de vouloir ; élan éteint, cendre, doute de soi. | à générer |
| O3-L1 | Extinction · Amplification | En chemin | **Le Veilleur du retour** | Protège les premières étincelles d'un désir qui renaît ; garde une braise. | à générer |
| O3-L1 | Extinction · Amplification | Intégré | **Le Gardien du vide fertile** | Peut ne plus rien vouloir sans perdre le lien à la vie ; vide comme espace disponible. | à générer |
| O3-L2 | Extinction · Exaltation | Bloqué | **Le Rebond d'ivresse** | Compense le vide par des phases d'exaltation ; oscillation extinction / intensité. | à générer |
| O3-L2 | Extinction · Exaltation | En chemin | **Le Phénix en mue** | Reconnaît que mort et renaissance d'un désir sont un même cycle ; mue. | à générer |
| O3-L2 | Extinction · Exaltation | Intégré | **Le Régénérateur du Désir** | Laisse mourir un ancien élan, accueille une nouvelle exaltation sans rejouer le passé. | à générer |
...
- **Priorité** : les **18 « à générer »** ci-dessus pour compléter le Désir (les 3 colonnes non-diagonales L1↔L3 / O1↔O3).
