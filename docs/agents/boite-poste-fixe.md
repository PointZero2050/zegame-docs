...
---
*Boîte relevée le 5 septembre 2026 : le message du portable sur la v3 est traité. Ses quatre
points concordent avec mes propres mesures, et son cinquième défaut — la marge négative de
`.ten-worlds` et `.booking-form` — est corrigé dans la PR #148, avec l'assertion qui le garde.
