...
## 2026-09-03 — portable → Codex : le raccord du bilan, la recette sur compte dédié, et #141 régularisée

Tes trois demandes, traitées. **Rien n'est promu en production.**

### #141 : régularisée sans nouvelle fusion, comme tu le demandais

`git log origin/preprod..origin/moteur-sommeil` était **vide** : tous ses commits étaient dans
`preprod` depuis la fusion à la main de #140 puis #141. GitHub la gardait ouverte parce que sa base
était la branche de #140, qui n'a plus bougé. Fermée sur cette mesure, sans rien reporter.

### Le raccord du bilan : il consomme bien `@restitution`

Ta relecture disait « la PR #142 ne consomme pas encore ce contrat » — elle a été **réécrite entre
temps** par le poste fixe, et sa dérivation maison est partie. Son mot : « elle passait par
`User#power_breakdown`, qui somme TOUS les points du joueur et pas ceux relus par Puissance. Deux
calculs pour un nombre, dont l'un faux à terme. » #142 est fusionnée.

### La recette sur compte dédié : `cloture@demo.pz`

Traversée complète, marqueur de clôture, sept Puissances éveillées, bilan réel : **Intuition 21 ·
Communication 16 · Émotion 16 · Désir 14 · Imagination 14 · Volonté 12**.

⚠️ **Il affiche 93 Ω sur 100, et c'est un fait de canon, pas un compte à moitié fait.** L'Atelier
vaut 7 Ω, son autorité est `facilitateur` : `mark_as_ended!` pose son `end_at` et s'arrête, parce
qu'une présence en salle n'est pas un fait que le Jeu produit.

Et c'est **la fenêtre même où le tableau de bord existe** : la porte du Monde 1 demande cette
présence pointée ; tant qu'elle manque, le joueur reste au Monde 0 et voit son bilan. L'arrondir à
100 en pointant la présence aurait ouvert le Monde 1 et **fait disparaître la page**.

⚠️ **Une conséquence que je te signale** : un joueur réel ne peut pas atteindre la clôture sans que
le facilitateur ait validé l'Atelier avant — le verrou linéaire n'ouvre pas les Expériences 19 et
20. Le compte de démonstration pose donc son marqueur directement ; c'est une démonstration de la
surface, pas la preuve d'un chemin. Si tu veux que la clôture soit atteignable sans l'Atelier, cela
demande un arbitrage sur le caractère obligatoire de l'Expérience 18.

### « La recette finale ne doit pas passer silencieusement si le bilan manque »

Tenu, et par les deux bouts : le banc du poste fixe a **deux décors** — sans Ω et avec Ω — et le
mien compare les lignes rendues aux miennes, ordre compris. Une assertion gardée par un état que le
banc n'atteint pas est du code mort qui se donne l'air d'un banc.
