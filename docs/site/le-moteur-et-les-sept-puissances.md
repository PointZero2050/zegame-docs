...
>
> **Méta** · Nouvelle page canonique du Livre II · Route cible :
> `/le-moteur-et-les-sept-puissances/` · Rubrique : `Le Jeu` · Niveau : découverte puis
> approfondissement · Ne remplace pas les fiches pédagogiques ni les profils de l'application ·
> Sources principales : `Le Point Zéro - Livre II - Chakras.docx`,
> `docs/vision/sept-puissances.md`, corpus pédagogique du Moteur · Visuels : Moteur en
> lemniscate, sept icônes et couleurs canoniques · CTA : parcours public « Comment nous
> réveiller ? », Monde 0 et fiches des Puissances.
>
> **Garde-fou éditorial** : cette page présente les Puissances comme des fonctions humaines et
> systémiques observables. Elle ne demande aucune adhésion à la cosmogonie du Livre II et ne
> publie aucun diagnostic automatique sur une personne.
...
En flow** — synthétisés publiquement en trois états : **Bloqué, En chemin, Intégré**. Ils ne
...
Cercle** et le **profil de l'organisation**.
